...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[7] = BW_MBPS(5000), /* At least 625 MHz on bus. */
	[8] = BW_MBPS(5290), /* At least 667 MHz on bus. */
};
...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[16] = { { 1215000, HFPLL, 1, 0x2D }, 1150000, 1150000, 6 },
#else
...
static struct acpu_level tbl_PVS1_1700MHz_factory_1134[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),  1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),  1012500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16), 1037500 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS2_1700MHz_factory_1134[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   950000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   975000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16), 1000000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS4_1700MHz_factory_1134[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16),  950000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS5_1700MHz_factory_1134[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16),  937500 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS0_1700MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),  1037500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16), 1075000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16), 1087500 },
	...
	{ 1, {  1998000, HFPLL, 1, 0x4A }, L2(15), 1350000 },
	{ 1, {  2052000, HFPLL, 1, 0x4C }, L2(15), 1350000 },
	{ 1, {  2106000, HFPLL, 1, 0x4E }, L2(15), 1350000 },
	{ 1, {  2133000, HFPLL, 1, 0x4F }, L2(14), 1350000 },
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	...
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(16), 1087500 },
...
static struct acpu_level tbl_PVS2_1700MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   975000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16), 1000000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16), 1012500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(16), 1037500 },
...
static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
	...
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(16), 1000000 },
...
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(16), 1150000 },
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
#ifdef CONFIG_LOW_CPUCLOCKS
	{ 1, {    81000, HFPLL, 1, 0x03 }, L2(0),   800000 },
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16),  950000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16),  962500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(16),  975000 },
...
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(16), 1125000 },
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(16),  937500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(16),  950000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(16),  962500 },
...
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(16), 1075000 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(16), 1075000 },
