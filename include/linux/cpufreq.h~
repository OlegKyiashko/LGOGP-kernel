...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ONDENAMDX)
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SIMPLEDEMAND)
extern struct cpufreq_governor cpufreq_gov_simpledemand;
#define CPUFREQ_DEFAULT_GOVERNOR  (&cpufreq_gov_simpledemand)
